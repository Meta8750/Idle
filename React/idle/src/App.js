...
function App() {
  ...
  return (
    <div className="App">
      ...
      <aside> <Sidebar  activeTab={activeTab} setActiveTab={setActiveTab} player={player} skills={skills}/> </aside>
      <main className={styles.main}> 
        <div>
          ...
          <div className={activeTab === 'Mining' ? styles.visible : styles.hidden}>
            <Logout activity={activity} setActivity={setActivity} time={time} skills={skills['Mining']}/>
          </div>
        </div>
      </main>
    </div>
